...
- 오늘의 누적 획득 토스 포인트
  - 예: `7원 / 300`
  - `7원`은 강조 색상으로 표시합니다.
  - 300원을 max로 하는 게이지를 표시합니다.
  - 안내 문구: `매일 자정 기준으로 한도 300원까지 모을 수 있어요`
- 보유 상자
  - 예: `18개 / 1000`
- 오늘 부스트 사용
  - 예: `3회 / 12`
...
- 포인트 화면 게이지가 `x원 / 300`, `x개 / 1000`, `x회 / 12`와 일치하는지 확인
